sap.ui.require([
  ...
  var sViewName = "tm.nutriTracker.myUI5App.view.MainView";
      ...
      assertions: {
          ...
          iShouldSeeTheTitle: function () {
            return this.waitFor({
              ...
              properties: {
                text: "tm.nutriTracker.myUI5App"
              },
              success: function() {
                Opa5.assert.ok(true, "The page shows the correct title");
              },
              errorMessage: "App does not show the expected title tm.nutriTracker.myUI5App"
            });
        }
      }
